...
PGPASSWORD=tma psql -h localhost -p 5432 -U tma -d tma_dev -c "DROP DATABASE tma;"
PGPASSWORD=tma psql -h localhost -p 5432 -U tma -d tma_dev -c "CREATE DATABASE tma:"
